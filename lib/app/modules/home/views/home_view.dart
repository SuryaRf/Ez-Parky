...
import 'package:ez_parky/app/data/models/options.dart';
import 'package:ez_parky/app/data/models/place.dart';
              ...
              child: Column(
                ...
                children: [
                  Padding(
                    ...
                    child: Text("On Parking Now", style: mediumText,),
                  ),
                  Image.asset("assets/img/mog.png",  width: width * 0.5,),

                  SizedBox(height: height * 0.05,),
                  Text("Baru saja dikunjungi", style: mediumText,),
                ...
                child: ListView.builder(
                  ...
                  Text("Disarankan untukmu", style: mediumText,),
                  SizedBox(height: height * 0.03,),
                  SizedBox(
                height: height * 0.3,
                child: ListView.builder(
